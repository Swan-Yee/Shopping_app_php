...
if($_POST){
	...
	if(empty($_POST['mail']) || empty($_POST['password'])){
		if(empty($_POST['mail'])){
			$mailError="Mail Input is required!";
		}
	...
	if($user){
		...
		echo "<script>alet('Innocort')</script>";
	}
}
					...
					<div class="login_form_inner">
                        ...
                        <input type="hidden" name="_token" value='<?php echo $_SESSION['_token']; ?>'>    
							<div class="col-md-12 form-group">
								...
								<input type="mail" class="form-control" id="name" name="mail" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
							</div>
							<div class="col-md-12 form-group">
