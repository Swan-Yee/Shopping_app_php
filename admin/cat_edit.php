...
if($_POST){
  if(empty($_POST['name']) || empty($_POST['description'])){
    ...
    if(empty($_POST['description'])){
      ...
      if($result){
          echo "<script>alert('Successfully Edit!');window.location.href='category.php';</script>";     
      }
    } 
  } 
?>
              ...
              <div class="card-body">
                    ...
                    <input type="hidden" name="_token" value="<?php echo $_SESSION['_token']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="Description" class="form-control"><?php echo $result[0]['description'] ?></textarea>
                        </div>
