      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card-body">
                  <div class="">
                    <a href="user_add.php" class="btn btn-success">Create New Users</a>
                  </div>                <br>
                      ...
                      <td>
                        <div class="row">
                          <div class="btn-group">
                            ...
                            <div class="container">
                              <a href="user_delete.php?id=<?php echo $value['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure To Detete')">Delete</a>
                            </div>
                          </div>
                        </div>
                      </td>
